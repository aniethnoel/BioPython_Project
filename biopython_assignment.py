# -*- coding: utf-8 -*-
"""BioPython Assignment.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EGmVug_H0CGiUlM9c5sI8-1ax9Pj-tI5
...
Entrez.email= 'anieth.gcu@gmail.com'
...
gene_output=open('/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/gene.fasta', 'w')
SeqIO.write(gene,gene_output,'fasta')
gene_output.close()

# Retrieving sequence only from the fasta file
for sequence in SeqIO.parse("/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/gene.fasta",'fasta'):
...
output_file = ('/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/protein_sequence_output.fasta')
...
input_file = "/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/interproscan_output.xml"
...
output_file = '/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/domain_sequence_output.fasta'
...
query_sequence = SeqIO.read("/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/domain_sequence_output.fasta", format="fasta")

# Perform BLASTP
result_handle = NCBIWWW.qblast("blastp", "nr", query_sequence.seq)

# Write the results to a xml file
with open("/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/domain_sequence_blastp_results.xml", "w") as out_handle:
...
input_file = "/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/domain_sequence_blastp_results.xml"
...
blast_xml_file = '/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/domain_sequence_blastp_results.xml'
...
output = open('/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/homologs.fasta', 'w')
...
org_name={}
for i in open("/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/homologs_headers.txt"): # This txt file is created by all the ID's and name in the BlastP Result XML file
  j= i.split("		")[0]
  k= i.split("[")[1].split("]")[0]
...
out=open("/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/homologs_org_names.fasta", 'w')
for i in SeqIO.parse("/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/homologs.fasta" ,'fasta'):
  j=i
  i.id=org_name[j.id]
  i.description=""
...
# Example usage
alignment = read_aln_clustal_num("/content/drive/MyDrive/Biopython Workshop/BioPython Assignment/clustalo-I20240504-163627-0753-24191988-p1m.aln-clustal_num")
